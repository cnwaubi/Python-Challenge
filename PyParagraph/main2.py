...
#sets file
textpath = os.path.join('Python-Challenge','PyParagraph','Resources','raw_data','paragraph_2.txt')
...
output_file = os.path.join('Python-Challenge','PyParagraph','Paragraph_Analysis','Analysis2.txt')
#sets output file
